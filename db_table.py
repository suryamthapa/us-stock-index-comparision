...
class db_table:
    ...
    DB_NAME = "us_stock_index_prices.db"
    ...
    def select_prices_between_dates(self, start_date, end_date, us_stock_index_type):
        sql = "SELECT Date, %s FROM Stocks WHERE Date BETWEEN %s AND %s" % (
            us_stock_index_type, start_date, end_date)
